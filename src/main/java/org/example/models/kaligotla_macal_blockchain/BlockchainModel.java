...
public class BlockchainModel extends AgentBasedModel<Globals> {
    ...
    public void step() {
        ...
        if (tick == 0) {
            ...
            run(MarketAgent.generateRandomCandidateTransaction(tick), MarketAgent.addCandidateTransactionsToPTQ(ptq));
